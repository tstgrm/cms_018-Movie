$(window).on("load", function () {
	...
	// TOP VOICE
	if ($(".js-top-voice-slider .swiper-slide").length > 1) {
		var topVoiceSwiper = new Swiper(".js-top-voice-slider .swiper", {
			loop: true,
			speed: 500,
			...
			// },
			navigation: {
				nextEl: ".js-top-voice-slider .swiper-button-next",
				prevEl: ".js-top-voice-slider .swiper-button-prev",
			},
			pagination: {
